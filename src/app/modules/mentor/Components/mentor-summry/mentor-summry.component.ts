...
@Component({
  selector: 'app-mentor-summry',
  templateUrl: './mentor-summry.component.html',
  styleUrl: './mentor-summry.component.css',
})
export class MentorSummryComponent implements OnInit {
  mentor = {
    name: 'Jitu Chauhan',
