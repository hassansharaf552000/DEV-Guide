...
export class ProfileComponent {
  ...
  ngOnInit(): void {
    ...
    const messageHiddenaprroval = localStorage.getItem('messageHiddenapproval');
    this.showMessageapproval = messageHiddenaprroval !== 'true';
    const hideMessagerejection = localStorage.getItem('hideMessagerejection');
  ...
  hideMessageaprroval(): void {
    ...
    localStorage.setItem('messageHiddenapproval', 'true');
  }
  hideMessagerejection(): void {
    // Hide the message and set a flag in localStorage
    this.Messagerejection = false;
    localStorage.setItem('hideMessagerejection', 'true');
  }
}
